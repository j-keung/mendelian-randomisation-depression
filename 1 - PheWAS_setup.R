...
#Access all the sheets downloaded from GWAS Atlas with readxl package 
...
#Attach all dataframes together with dplyr package 
...
#Count number of occurrences of each domain using tidyverse package and turn into a dataframe 
